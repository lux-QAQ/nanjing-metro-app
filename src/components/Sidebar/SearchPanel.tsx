...
export const SearchPanel: React.FC<SearchPanelProps> = ({
  ...
  return (
    // 动效 1: 面板整体淡入 (Entrance Animation)
    // timeout={600} 让它缓慢出现，显得更优雅
    <Fade in={true} timeout={600}>
      <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column', bgcolor: 'transparent' }}>
        <Box sx={{ p: 3, overflowY: 'auto' }}>
          ...
          <Box sx={{ mb: 2 }}>
            <Stepper
              ...
              sx={{
                ...
                '& .MuiStepLabel-label': { width: '100%' },
                '& .MuiStepLabel-iconContainer': { pr: 2, p: 0 },
                '& .MuiStep-root': { mb: 0 }
              }}
            >
              {/* 起点 */}
                        ...
                        <IconButton
                          ...
                          sx={{
                            ...
                            '&:hover': {
                              ...
                              color: 'white',
                              transform: `rotate(${swapRotation}deg) scale(1.1)`
                            }
                          }}
                        >
          ...
          {/* 动效 3: 高级设置面板 - 组合 Collapse 和 Fade */}
          <Collapse in={showAdvanced}>
            {/* Fade 确保内容在展开时也是淡入的，而不是生硬出现 */}
